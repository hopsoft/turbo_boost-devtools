var N=Object.defineProperty,G=Object.defineProperties;var F=Object.getOwnPropertyDescriptors;var R=Object.getOwnPropertySymbols;var W=Object.prototype.hasOwnProperty,K=Object.prototype.propertyIsEnumerable;var O=(e,t,o)=>t in e?N(e,t,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[t]=o,d=(e,t)=>{for(var o in t||(t={}))W.call(t,o)&&O(e,o,t[o]);if(R)for(var o of R(t))K.call(t,o)&&O(e,o,t[o]);return e},c=(e,t)=>G(e,F(t));function V(e){let t=document.createElement("template");return t.innerHTML=e,t}function b(e,t){t=t||document.body;let n=V(e).content.cloneNode(!0).querySelector("*");return t.appendChild(n)}function w(e,t={}){if(!e)return;k(e);let{outline:o,outlineOffset:n}=t;o=o||"dashed 3px red",n=n||"0px",e.originalStyles=e.originalStyles||{display:e.style.display,minHeight:e.style.minHeight,minWidth:e.style.minWidth,outline:e.style.outline,outlineOffset:e.style.outlineOffset},getComputedStyle(e).display.match(/^inline$/i)&&e.offsetWidth===0&&e.offsetHeight===0&&(e.style.display="inline-block",e.style.minHeight="2px",e.style.minWidth="2px"),e.style.outline=o,e.style.outlineOffset=n,e.dataset.turboBoostHighlight=!0}function k(e){if(e){if(e.originalStyles){for(let[t,o]of Object.entries(e.originalStyles))o?e.style[t]=o:e.style[t]="";delete e.originalStyles}delete e.dataset.turboBoostHighlight}}function T(e){if(!e)return{};let t=e.getBoundingClientRect(),o=e.offsetWidth,n=e.offsetHeight,i=t.top+window.scrollY,l=t.left+window.scrollX,r=l+o,a=i+n;return{top:i,left:l,right:r,bottom:a,width:o,height:n}}function h(e){try{e()}catch(t){}}var m=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=this.html,this.labelElement.addEventListener("click",t=>{t.preventDefault(),this.toggle()}),this.checkboxElement.addEventListener("change",t=>this.dispatchEvent(new CustomEvent("change",{bubbles:!0})))}toggle(){this.checked?this.uncheck():this.check()}check(){this.checkboxElement.checked=!0,this.dispatchEvent(new CustomEvent("change",{bubbles:!0}))}uncheck(){this.checkboxElement.checked=!1,this.dispatchEvent(new CustomEvent("change",{bubbles:!0}))}get name(){return this.getAttribute("name")}get checked(){return this.checkboxElement.checked}get checkboxElement(){return this.shadowRoot.querySelector("input")}get labelElement(){return this.shadowRoot.querySelector("label")}get html(){return`
    ...
    `}};var f=class extends HTMLElement{constructor(){super(),this.enabledDevtools={},this.attachShadow({mode:"open"}),this.shadowRoot.innerHTML=this.html,this.shadowRoot.querySelector("button").addEventListener("click",()=>this.dispatchEvent(new CustomEvent("turbo-boost:devtools-close",{bubbles:!0}))),this.addEventListener("change",t=>{let o=t.target,{checked:n,name:i}=o;n?this.enableDevtool(i):this.disableDevtool(i)})}enableDevtool(t){this.enabledDevtools[t]||(this.enabledDevtools[t]=!0,this.dispatchEvent(new CustomEvent("turbo-boost:devtool-enable",{bubbles:!0,detail:{name:t}})))}disableDevtool(t){this.enabledDevtools[t]&&(delete this.enabledDevtools[t],this.dispatchEvent(new CustomEvent("turbo-boost:devtool-disable",{bubbles:!0,detail:{name:t}})))}close(){this.devtoolElements.forEach(t=>{t.checked&&t.uncheck()}),this.remove()}get devtoolElements(){return this.querySelectorAll('[slot="devtool"]')}get closeElement(){return this.querySelector("button")}get html(){return`
      <style>${this.stylesheet}</style>
      <div>
    ...
    `}};var g=[],_={LeaderLine:{src:"https://cdnjs.cloudflare.com/ajax/libs/leader-line/1.0.7/leader-line.min.js",integrity:"sha512-0dNdzMjpT6pJdFGF1DwybFCfm3K/lzHhxaMXC/92J9/DZujHlqYFqmhTOAoD0o+LkeEsVK2ar/ESs7/Q2B6wJg==",global:"LeaderLine"},PlainDraggable:{src:"https://cdn.jsdelivr.net/npm/plain-draggable@2.5.14/plain-draggable.min.js",global:"PlainDraggable"}};function I(e){return e.global&&self[e.global]||document.querySelector(`[src='${e.src}']`)?!0:g.includes(e)}function J(e){if(I(e))return;g.push(e);let{src:t,integrity:o}=e,n=document.createElement("script");n.setAttribute("src",t),n.setAttribute("crossorigin","anonymous"),n.setAttribute("referrerpolicy","no-referrer"),o&&n.setAttribute("integrity",o),document.head.appendChild(n)}function j(e){if(!g.includes(e))return;g.splice(g.indexOf(e),1);let{src:t}=e,o=document.querySelector(`script[src='${t}']`);o&&o.remove(),e.global&&self[e.global]&&(self[e.global]=null)}function U(){[...g].forEach(e=>j(e))}var u=c(d({},_),{add:J,remove:j,removeAll:U});customElements.define("turbo-boost-devtool",m);customElements.define("turbo-boost-devtool-supervisor",f);customElements.define("turbo-boost-devtool-tooltip",v);var s;function A(){if(s)try{new PlainDraggable(s)}catch(e){setTimeout(A,200)}}function C(){q()||(s.close(),s.dispatchEvent(new CustomEvent("turbo-boost:devtools-stop",{bubbles:!0})),s=null,u.removeAll())}function B(){L()||(u.add(u.LeaderLine),u.add(u.PlainDraggable),s=b("<turbo-boost-devtool-supervisor></turbo-boost-devtool-supervisor>"),setTimeout(A,200),s.dispatchEvent(new CustomEvent("turbo-boost:devtools-start",{bubbles:!0})))}function X(){let e=s?Object.keys(s.enabledDevtools):[];C(),B(),s.devtoolElements.forEach(t=>{e.includes(t.name)&&t.check()})}function L(){return!!s}function q(){return!L()}var z;function P(){clearTimeout(z),z=setTimeout(X,25)}function y(){L()&&P()}addEventListener("turbo:load",y);addEventListener("turbo-frame:load",y);addEventListener("turbo-boost:devtools-connect",y);addEventListener("turbo-boost:devtools-close",C);window.TurboBoost&&(addEventListener(TurboBoost.Commands.events.success,y),addEventListener(TurboBoost.Commands.events.finish,y));function Y(e,t){if(s)return b(`
      <turbo-boost-devtool name="${e}" slot="devtool">
        <span slot="label">${t}</span>
      </turbo-boost-devtool>
    `,s)}function Q(e){return s?s.enabledDevtools[e]:!1}var E={enabled:Q,register:Y,start:B,stop:C,restart:P,get started(){return L()},get stopped(){return q()}};function S(e,t,o,n={}){let{backgroundColor:i,color:l,position:r}=n;return l=l||"white",r=r||"top",b(`
  ...
  `)}var M,$=class{constructor(t){this.delegate=t;let o,n=()=>{clearTimeout(o),o=setTimeout(this.hide({active:!1}),25)};this.eventListeners["turbo-boost:devtool-enable"]=i=>{let{name:l}=i.detail;l===this.delegate.name&&(w(this.delegate.triggerElement,{outline:"3px dashed blueviolet",outlineOffset:"2px"}),this.hide({active:!1}),this.active&&this.show())},this.eventListeners["turbo-boost:devtool-disable"]=i=>{let{name:l}=i.detail;l===this.delegate.name&&k(this.delegate.triggerElement)},this.eventListeners.click=i=>{i.target.closest("turbo-boost-devtool-tooltip")||n()},this.eventListeners["turbo:load"]=n,this.eventListeners["turbo-frame:load"]=n,window.TurboBoost&&(this.eventListeners[TurboBoost.Commands.events.finish]=n),this.registerEventListeners()}registerEventListeners(){Object.entries(this.eventListeners).forEach(([t,o])=>{addEventListener(t,o)})}unregisterEventListeners(){Object.entries(this.eventListeners).forEach(([t,o])=>{removeEventListener(t,o)})}get eventListeners(){return this._eventListeners||(this._eventListeners={})}show(){if(!this.enabled||this.active)return;this.active=!0,this.hide({active:!0}),w(this.delegate.targetElement,{outline:"3px dashed darkcyan",outlineOffset:"-2px"}),w(this.delegate.morphElement,{outline:"3px dashed chocolate",outlineOffset:"3px"}),this.renderingTooltip=this.createRenderingTooltip(),this.targetTooltip=this.createTargetTooltip(),this.triggerTooltip=this.createTriggerTooltip(this.targetTooltip,this.renderingTooltip),document.querySelectorAll(".leader-line").forEach(o=>o.style.zIndex=1e5);let t={morph:{partial:this.delegate.triggerElement.renders,id:this.delegate.triggerElement.morphs,status:this.delegate.morphElement?"OK":"Not Found"},trigger:{partial:null,id:null,status:"Not Found"},target:{partial:null,id:null,status:"Not Found"}};this.delegate.triggerElement&&(t.trigger={partial:this.delegate.triggerElement.partial,id:this.delegate.triggerElement.id,status:"OK"},t.target.id=this.delegate.triggerElement.controls),this.delegate.targetElement&&(t.target={partial:this.delegate.targetElement.partial,dom_id:this.delegate.targetElement.id,status:"OK"}),console.table(t)}hide({active:t=!1}){document.querySelectorAll("turbo-boost-devtool-tooltip").forEach(o=>{h(()=>o.line.remove()),h(()=>o.drag.remove()),h(()=>o.lineToRendering.remove()),h(()=>o.lineToTarget.remove()),h(()=>o.remove())}),document.querySelectorAll("[data-turbo-boost-highlight]").forEach(o=>{o.tagName.match(/turbo-boost-toggle-trigger/i)||k(o)}),this.active=t}get active(){return M===this.delegate}set active(t){t?M=this.delegate:M=null}get enabled(){return E.enabled(this.delegate.name)}static register(t,o){E.register(t,o)}createRenderingTooltip(){if(!this.delegate.triggerElement.renders)return console.debug("Unable to create the rendering tooltip! The trigger element must set the 'renders' attribute.");if(!this.delegate.triggerElement.morphs)return console.debug(`Unable to create the rendering tooltip! The trigger element specified the 'morphs' attrbiute but no element matches the DOM id: '${this.triggerElement.morphs}'`);let t=`
    ...
    `,n=this.delegate.targetElement.viewStack.reverse().map((p,x)=>this.delegate.triggerElement.sharedViews.includes(p)?`<div slot="content">${x+1}. ${p}</div>`:`<div slot="content-bottom">${x+1}. ${p}</div>`,this).join("");n=`
      ...
      ${n}
    `;let i=S(t,o,n,{backgroundColor:"lightcyan",color:"darkcyan",position:"bottom"}),l=T(this.delegate.targetElement),r=Math.ceil(l.top+i.offsetHeight),a=Math.ceil(l.left+l.width+i.offsetWidth/3);return i.style.top=`${r}px`,i.style.left=`${a}px`,i.line=new LeaderLine(i,this.delegate.targetElement,c(d({},this.leaderLineOptions),{color:"darkcyan"})),i.drag=new PlainDraggable(i),i}createTriggerTooltip(t,o){if(!this.delegate.triggerElement)return;let n=`
